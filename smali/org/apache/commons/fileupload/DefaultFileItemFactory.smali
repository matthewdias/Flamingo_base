...
.method public createItem(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;)Lorg/apache/commons/fileupload/FileItem;
    ...
    .line 2
    invoke-virtual {p0}, Lorg/apache/commons/fileupload/disk/DiskFileItemFactory;->getSizeThreshold()I

    move-result v5

    invoke-virtual {p0}, Lorg/apache/commons/fileupload/disk/DiskFileItemFactory;->getRepository()Ljava/io/File;
