...
.method public static a(Landroid/content/Context;Lf1/i;Ljava/lang/String;)V
    .locals 4
    ...
    .line 2
    invoke-virtual {p1}, Landroidx/work/impl/WorkDatabase;->z()Ln1/h;

    move-result-object p1

    .line 3
    invoke-interface {p1, p2}, Ln1/h;->c(Ljava/lang/String;)Ln1/g;
    ...
    .line 7
    invoke-virtual {p0, v0, v1, v2}, Le1/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    .line 8
    invoke-interface {p1, p2}, Ln1/h;->d(Ljava/lang/String;)V
...
.method private static b(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, v2, p1, p2}, Le1/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public static c(Landroid/content/Context;Lf1/i;Ljava/lang/String;J)V
    .locals 2
    ...
    .line 3
    invoke-interface {v0, p2}, Ln1/h;->c(Ljava/lang/String;)Ln1/g;
    ...
    invoke-direct {v1, p1}, Lo1/c;-><init>(Landroidx/work/impl/WorkDatabase;)V

    .line 7
    invoke-virtual {v1}, Lo1/c;->b()I
    ...
    invoke-direct {v1, p2, p1}, Ln1/g;-><init>(Ljava/lang/String;I)V

    .line 9
    invoke-interface {v0, v1}, Ln1/h;->b(Ln1/g;)V
