...
.method private f()Z
    ...
    invoke-interface {v0, v1, v2, v3}, Li5/g;->read([BII)I
    ...
    invoke-interface {v7, v4, v6, v5}, Li5/g;->read([BII)I
    ...
    invoke-direct {v2, v4, v0}, Lj5/w;-><init>([BI)V

    invoke-interface {v1, v2}, Lcom/google/android/exoplayer2/source/k$a;->b(Lj5/w;)V
