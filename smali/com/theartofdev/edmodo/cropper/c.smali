...
.method public static d(Landroid/graphics/Bitmap;[FIZII)Landroid/graphics/Bitmap;
    .locals 8
    ...
    invoke-static/range {v0 .. v5}, Lcom/theartofdev/edmodo/cropper/c;->s([FIIZII)Landroid/graphics/Rect;
...
.method public static e(Landroid/content/Context;Landroid/net/Uri;[FIIIZIIII)Lcom/theartofdev/edmodo/cropper/c$a;
    .locals 14
    ...
    .line 1
    :try_start_0
    invoke-static/range {v1 .. v12}, Lcom/theartofdev/edmodo/cropper/c;->f(Landroid/content/Context;Landroid/net/Uri;[FIIIZIIIII)Lcom/theartofdev/edmodo/cropper/c$a;
...
.method private static f(Landroid/content/Context;Landroid/net/Uri;[FIIIZIIIII)Lcom/theartofdev/edmodo/cropper/c$a;
    .locals 12
    ...
    .line 4
    :try_start_0
    invoke-static/range {v2 .. v7}, Lcom/theartofdev/edmodo/cropper/c;->l(Landroid/content/Context;Landroid/net/Uri;Landroid/graphics/Rect;III)Lcom/theartofdev/edmodo/cropper/c$a;
    ...
    .line 7
    :try_start_1
    invoke-static {v1, p3}, Lcom/theartofdev/edmodo/cropper/c;->B(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    .line 13
    invoke-static/range {v1 .. v11}, Lcom/theartofdev/edmodo/cropper/c;->g(Landroid/content/Context;Landroid/net/Uri;[FIZIIILandroid/graphics/Rect;II)Lcom/theartofdev/edmodo/cropper/c$a;
...
.method private static g(Landroid/content/Context;Landroid/net/Uri;[FIZIIILandroid/graphics/Rect;II)Lcom/theartofdev/edmodo/cropper/c$a;
    .locals 12
    ...
    invoke-static {v5, p1, v3}, Lcom/theartofdev/edmodo/cropper/c;->i(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 7
    invoke-static/range {v6 .. v11}, Lcom/theartofdev/edmodo/cropper/c;->d(Landroid/graphics/Bitmap;[FIZII)Landroid/graphics/Bitmap;
...
.method private static h(Landroid/graphics/Bitmap;[FLandroid/graphics/Rect;IZII)Landroid/graphics/Bitmap;
    .locals 8
    ...
    .line 11
    invoke-static {p2, p5, p6}, Lcom/theartofdev/edmodo/cropper/c;->m(Landroid/graphics/Rect;II)V
...
.method private static i(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 2
...
.method private static j(Landroid/content/ContentResolver;Landroid/net/Uri;)Landroid/graphics/BitmapFactory$Options;
    .locals 1
...
.method public static k(Landroid/content/Context;Landroid/net/Uri;II)Lcom/theartofdev/edmodo/cropper/c$a;
    .locals 3
    ...
    .line 2
    invoke-static {p0, p1}, Lcom/theartofdev/edmodo/cropper/c;->j(Landroid/content/ContentResolver;Landroid/net/Uri;)Landroid/graphics/BitmapFactory$Options;
    ...
    .line 7
    invoke-static {p0, p1, v0}, Lcom/theartofdev/edmodo/cropper/c;->i(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method private static l(Landroid/content/Context;Landroid/net/Uri;Landroid/graphics/Rect;III)Lcom/theartofdev/edmodo/cropper/c$a;
    .locals 4
...
.method public static m(Landroid/graphics/Rect;II)V
    .locals 1
...
.method private static n(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/File;
    .locals 9
...
.method public static s([FIIZII)Landroid/graphics/Rect;
    ...
    .line 6
    invoke-static {p2, p4, p5}, Lcom/theartofdev/edmodo/cropper/c;->m(Landroid/graphics/Rect;II)V
...
.method public static y(Landroid/graphics/Bitmap;IILcom/theartofdev/edmodo/cropper/CropImageView$RequestSizeOptions;)Landroid/graphics/Bitmap;
    .locals 5
    ...
    sget-object v1, Lcom/theartofdev/edmodo/cropper/CropImageView$RequestSizeOptions;->g:Lcom/theartofdev/edmodo/cropper/CropImageView$RequestSizeOptions;
    ...
    .line 2
    sget-object v2, Lcom/theartofdev/edmodo/cropper/CropImageView$RequestSizeOptions;->g:Lcom/theartofdev/edmodo/cropper/CropImageView$RequestSizeOptions;
...
.method public static z(Landroid/graphics/Bitmap;Landroid/content/Context;Landroid/net/Uri;)Lcom/theartofdev/edmodo/cropper/c$b;
    .locals 0

    .line 1
    :try_start_0
    invoke-static {p1, p2}, Lcom/theartofdev/edmodo/cropper/c;->n(Landroid/content/Context;Landroid/net/Uri;)Ljava/io/File;
    ...
    .line 4
    invoke-static {p0, p2}, Lcom/theartofdev/edmodo/cropper/c;->A(Landroid/graphics/Bitmap;Landroid/media/ExifInterface;)Lcom/theartofdev/edmodo/cropper/c$b;
