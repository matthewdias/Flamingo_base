.class Lcom/samruston/twitter/api/API$o0;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/samruston/twitter/api/API;->w0(Landroid/content/Context;JJLcom/samruston/twitter/api/API$m3;)V
.end annotation
...
.method constructor <init>(Lcom/samruston/twitter/api/API$g3;Ll8/a;JLandroid/content/Context;JLcom/samruston/twitter/api/API$m3;)V
    ...
    .line 1
    iput-wide p3, p0, Lcom/samruston/twitter/api/API$o0;->d:J

    iput-object p5, p0, Lcom/samruston/twitter/api/API$o0;->e:Landroid/content/Context;

    iput-wide p6, p0, Lcom/samruston/twitter/api/API$o0;->f:J

    iput-object p8, p0, Lcom/samruston/twitter/api/API$o0;->g:Lcom/samruston/twitter/api/API$m3;
...
.method public bridge synthetic d()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/samruston/twitter/api/API$o0;->f()Landroid/util/Pair;
...
.method public bridge synthetic e(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/samruston/twitter/api/API$o0;->g(Landroid/util/Pair;)V
...
.method public f()Landroid/util/Pair;
    ...
    .line 1
    iget-wide v0, p0, Lcom/samruston/twitter/api/API$o0;->d:J
    ...
    .line 2
    iget-object v0, p0, Lcom/samruston/twitter/api/API$o0;->e:Landroid/content/Context;
    ...
    iget-wide v5, p0, Lcom/samruston/twitter/api/API$o0;->f:J
    ...
    iget-wide v7, p0, Lcom/samruston/twitter/api/API$o0;->d:J
    ...
    iget-wide v9, p0, Lcom/samruston/twitter/api/API$o0;->f:J

    iget-wide v11, p0, Lcom/samruston/twitter/api/API$o0;->d:J

    const/16 v13, 0xc8

    invoke-interface/range {v8 .. v13}, Ltwitter4j/api/FriendsFollowersResources;->getFollowersList(JJI)Ltwitter4j/PagableResponseList;
    ...
    iget-object v2, p0, Lcom/samruston/twitter/api/API$o0;->e:Landroid/content/Context;

    new-instance v4, Lcom/samruston/twitter/api/API$w2;

    new-array v3, v3, [Ljava/lang/Object;

    iget-wide v8, p0, Lcom/samruston/twitter/api/API$o0;->f:J
    ...
    iget-wide v8, p0, Lcom/samruston/twitter/api/API$o0;->d:J
...
.method public g(Landroid/util/Pair;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/samruston/twitter/api/API$o0;->g:Lcom/samruston/twitter/api/API$m3;
