.class Lcom/samruston/twitter/api/API$n;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/samruston/twitter/api/API;->N0(Landroid/content/Context;Ljava/lang/String;Ltwitter4j/Query;Lcom/samruston/twitter/api/API$j3;)V
.end annotation
...
.method constructor <init>(Lcom/samruston/twitter/api/API$g3;Ll8/a;Landroid/content/Context;Ljava/lang/String;Ltwitter4j/Query;Lcom/samruston/twitter/api/API$j3;)V
    ...
    .line 1
    iput-object p3, p0, Lcom/samruston/twitter/api/API$n;->d:Landroid/content/Context;

    iput-object p4, p0, Lcom/samruston/twitter/api/API$n;->e:Ljava/lang/String;

    iput-object p5, p0, Lcom/samruston/twitter/api/API$n;->f:Ltwitter4j/Query;

    iput-object p6, p0, Lcom/samruston/twitter/api/API$n;->g:Lcom/samruston/twitter/api/API$j3;
...
.method public bridge synthetic d()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/samruston/twitter/api/API$n;->f()Landroid/util/Pair;
...
.method public bridge synthetic e(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/samruston/twitter/api/API$n;->g(Landroid/util/Pair;)V
...
.method public f()Landroid/util/Pair;
    ...
    .line 1
    iget-object v0, p0, Lcom/samruston/twitter/api/API$n;->d:Landroid/content/Context;

    sget-object v1, Lcom/samruston/twitter/api/API$CacheType;->f:Lcom/samruston/twitter/api/API$CacheType;
    ...
    iget-object v5, p0, Lcom/samruston/twitter/api/API$n;->e:Ljava/lang/String;

    const/4 v6, 0x0

    aput-object v5, v4, v6

    iget-object v5, p0, Lcom/samruston/twitter/api/API$n;->f:Ltwitter4j/Query;
    ...
    .line 2
    iget-object v2, p0, Lcom/samruston/twitter/api/API$n;->f:Ltwitter4j/Query;
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lcom/samruston/twitter/api/API$n;->e:Ljava/lang/String;
    ...
    .line 6
    iget-object v2, p0, Lcom/samruston/twitter/api/API$n;->d:Landroid/content/Context;
    ...
    iget-object v4, p0, Lcom/samruston/twitter/api/API$n;->f:Ltwitter4j/Query;
...
.method public g(Landroid/util/Pair;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/samruston/twitter/api/API$n;->g:Lcom/samruston/twitter/api/API$j3;
