.class Lcom/samruston/twitter/settings/c$a;
.super Ljava/lang/Object;
.source "MyApplication"

# interfaces
.implements Lcom/samruston/twitter/settings/c$c;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/samruston/twitter/settings/c;->Y(Landroid/os/Bundle;)V
.end annotation
...
# instance fields
.field final synthetic a:Lcom/samruston/twitter/settings/c;


# direct methods
.method constructor <init>(Lcom/samruston/twitter/settings/c;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/samruston/twitter/settings/c$a;->a:Lcom/samruston/twitter/settings/c;
...
.method public a(I)V
    ...
    .line 1
    iget-object v0, p0, Lcom/samruston/twitter/settings/c$a;->a:Lcom/samruston/twitter/settings/c;

    invoke-virtual {v0}, Landroidx/fragment/app/Fragment;->m()Landroidx/fragment/app/d;

    move-result-object v0

    invoke-static {v0, p1}, Lu8/a;->f(Landroid/content/Context;I)V

    .line 2
    iget-object v0, p0, Lcom/samruston/twitter/settings/c$a;->a:Lcom/samruston/twitter/settings/c;

    invoke-static {v0}, Lcom/samruston/twitter/settings/c;->v1(Lcom/samruston/twitter/settings/c;)Lcom/samruston/twitter/settings/c$b;
...
.method public b()V
    ...
    iget-object v1, p0, Lcom/samruston/twitter/settings/c$a;->a:Lcom/samruston/twitter/settings/c;
    ...
    .line 3
    iget-object v2, p0, Lcom/samruston/twitter/settings/c$a;->a:Lcom/samruston/twitter/settings/c;
    ...
    new-instance v1, Lcom/samruston/twitter/settings/c$a$b;

    invoke-direct {v1, p0}, Lcom/samruston/twitter/settings/c$a$b;-><init>(Lcom/samruston/twitter/settings/c$a;)V
...
.method public c(I)V
    ...
    invoke-static {v1}, Lu8/a;->d(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    check-cast v1, Lu8/a$a;

    invoke-virtual {v1}, Lu8/a$a;->b()J

    move-result-wide v1

    new-instance v3, Lcom/samruston/twitter/settings/c$a$a;

    invoke-direct {v3, p0, p1}, Lcom/samruston/twitter/settings/c$a$a;-><init>(Lcom/samruston/twitter/settings/c$a;I)V
